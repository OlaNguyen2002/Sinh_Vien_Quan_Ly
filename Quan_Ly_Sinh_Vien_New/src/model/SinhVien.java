...
public class SinhVien implements Serializable{
	...
	@Override
	public int hashCode() {
		return Objects.hash(diemMon1, diemMon2, diemMon3, gioiTinh, maSinhVien, ngaySinh, queQuan, tenSinhVien);
	}
	...
	public boolean equals(Object obj) {
		...
		return Float.floatToIntBits(diemMon1) == Float.floatToIntBits(other.diemMon1)
				...
				&& maSinhVien == other.maSinhVien && Objects.equals(ngaySinh, other.ngaySinh)
				&& Objects.equals(queQuan, other.queQuan) && Objects.equals(tenSinhVien, other.tenSinhVien);
	}
