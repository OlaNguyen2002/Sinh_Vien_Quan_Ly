...
public class QLSVView extends JFrame {
	...
	public QLSVView() {
		...
		label_maSinhVien.setBounds(285, 11, 155, 54);
		...
		textField_MaSinhVien_TimKiem.setBounds(393, 12, 123, 54);
		...
		label_HoVaTen_2.setBounds(324, 473, 75, 23);
		...
		textField_Mon1.setBounds(431, 470, 166, 29);
		...
		label_HoVaTen_2_1.setBounds(324, 513, 75, 23);
		...
		textField_Mon3.setBounds(431, 554, 166, 29);
	...
	public void themSinhVienVaoTable(SinhVien ts) {
	...
	public void themHoacCapNhatSinhVien(SinhVien ts) {
		DefaultTableModel model_table = (DefaultTableModel) table.getModel();
		if (!this.model.kiemTraTonTai(ts)) {
			...
			for (int i = 0; i < soLuongDong; i++) {
				...
				if (id.equals(ts.getMaSinhVien() + "")) {
					model_table.setValueAt(ts.getMaSinhVien() + "", i, 0);
					model_table.setValueAt(ts.getTenSinhVien() + "", i, 1);
	...
	public SinhVien getSinhVienDangChon() {
		...
		SinhVien ts = new SinhVien(maSinhVien, tenSinhVien, tinh, ngaySinh, gioiTinh, diemMon1, diemMon2, diemMon3);
		return ts;
	}

	public void hienThiThongTinSinhVienDaChon() {
		SinhVien ts = getSinhVienDangChon();

		this.textField_ID.setText(ts.getMaSinhVien() + "");
		this.textField_HoVaTen.setText(ts.getTenSinhVien() + "");
	...
	public void thucHienTim() {
		...
		String maSinhVienTimKiem = this.textField_MaSinhVien_TimKiem.getText();
		DefaultTableModel model_table = (DefaultTableModel) table.getModel();
		int soLuongDong = model_table.getRowCount();
	...
	public void thucHienTaiLaiDuLieu() {
		...
		for (SinhVien ts : this.model.getDsSinhVien()) {
			this.themSinhVienVaoTable(ts);
		}
	}
